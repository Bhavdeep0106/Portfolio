...
const page = () => {
  const items = [
    ...
    { hobby: "Watching Good Biographies" },
    { hobby: "Playing Games" },
  ];
      ...
      <div className="flex flex-col gap-5">
        ...
        <FramerWrapper y={0} x={100}>
          <p className=" font-poppins text-xl w-full text-primary max-sm:text-lg ">
            I am a Full Stack Web Developer from New Delhi,
            India. I love crafting web projects  that could help me and
            someone in there day to day life. I have worked in modern
            JavaScript frameworks and responsive CSS design, focusing on
            creating good-looking and user-friendly interfaces. With strong
            attention to detail and efficient delivery.
          </p>
        </FramerWrapper>
      </div>
      <FramerWrapper
